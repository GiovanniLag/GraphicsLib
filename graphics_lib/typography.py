...
# Import registry for example typography registration
from graphics_lib.core.registry import TypographyRegistry


# Example Typography: Quantum Science
QScienceTypography = Typography(
    title=Font('Palatino', 20, 'serif'),
    subtitle=Font('Palatino', 16, 'serif'),
    body=Font('Verdana', 12, 'sans-serif'),
    caption=Font('Verdana', 10, 'sans-serif')
)

# Register the example typography
TypographyRegistry.register('qscience', QScienceTypography)


__all__ = ['Font', 'Typography', 'QScienceTypography']